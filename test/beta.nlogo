...
turtles-own [
  xval  ;; the value drawn from Beta
]
...
to plot-turtle-bars
  set-current-plot "Turtles ordered by opinion"
  clear-plot

  let sorted-turtles sort-by [[a b] -> [xval] of a < [xval] of b] turtles

  let index 0
  foreach sorted-turtles [
    t ->
      let xvalordered [xval] of t
      plotxy index 0
